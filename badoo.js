window.opener = localStorage.getItem("opener") || "Привет! Чем занимаешься? ;)";
...
window.bot = {
	...
	massLike: function(){
		bot.getUsers().then(function(data){
			users = data.filter(function(user) {
				return user.online_status_text !== "Была онлайн больше недели назад"
					&& user.online_status_text !== "Была онлайн больше месяца назад";
			});

      // Была онлайн больше месяца назад
      // Была онлайн больше недели назад
	...
	massChat: function(){
		bot.getUsers().then(function(data){
			users = data.filter(function(user){return user.online_status_text != "online_status_text" && user.online_status_text != " Была онлайн больше недели назад"});
